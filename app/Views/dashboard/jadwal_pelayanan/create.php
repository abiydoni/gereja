            ...
            row.innerHTML = `
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                    ...
                    <div class="col-span-1 md:col-span-3">
                        ...
                        <textarea name="petugas_pagi[]" rows="3" class="input-pagi w-full px-3 py-2 bg-white border border-blue-100 rounded-lg focus:ring-2 focus:ring-blue-100 outline-none transition-all text-xs min-h-[38px] placeholder-slate-300" placeholder="-"></textarea>
                    </div>

                    <!-- Siang Input -->
                    <div class="col-span-1 md:col-span-3">
                        <label class="md:hidden block text-[10px] font-bold text-orange-400 uppercase tracking-wider mb-1">Siang</label>
                        <textarea name="petugas_siang[]" rows="3" class="input-siang w-full px-3 py-2 bg-white border border-orange-100 rounded-lg focus:ring-2 focus:ring-orange-100 outline-none transition-all text-xs min-h-[38px] placeholder-slate-300" placeholder="-"></textarea>
                    </div>
                    
                    <!-- Sore Input -->
                    <div class="col-span-1 md:col-span-3">
                        <label class="md:hidden block text-[10px] font-bold text-indigo-400 uppercase tracking-wider mb-1">Sore</label>
                        <textarea name="petugas_sore[]" rows="3" class="input-sore w-full px-3 py-2 bg-white border border-indigo-100 rounded-lg focus:ring-2 focus:ring-indigo-100 outline-none transition-all text-xs min-h-[38px] placeholder-slate-300" placeholder="-"></textarea>
                    </div>
                </div>
            `;
