            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="nama_ibadah" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium placeholder-slate-400" placeholder="Contoh: Ibadah Minggu Raya" value="Ibadah Minggu Raya" required>
                    </div>
                    <div class="space-y-2">
                         <label class="block text-sm font-bold text-slate-700">Tema Ibadah</label>
                         <input type="text" name="tema" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium placeholder-slate-400" placeholder="Contoh: Hidup yang Berbuah">
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input type="date" name="tanggal" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium text-slate-600" required value="<?= date('Y-m-d', strtotime('next Sunday')) ?>">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-sm font-bold text-slate-700">Jam <span class="text-rose-500">*</span></label>
                            <input type="time" name="jam" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium text-slate-600" required value="09:00">
                        </div>
                    </div>
                    <div class="space-y-2">
            ...
            <div id="petugas-container" class="space-y-4">
                ...
                <div class="petugas-row grid grid-cols-1 md:grid-cols-12 gap-4 items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100 shadow-sm group hover:border-indigo-200 transition-all">
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="jenis_tugas[]" class="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium" placeholder="Contoh: Pengkotbah" value="Pengkotbah">
                        </div>
                    </div>
                ...
                <div class="petugas-row grid grid-cols-1 md:grid-cols-12 gap-4 items-center bg-slate-50/50 p-4 rounded-xl border border-slate-100 shadow-sm group hover:border-indigo-200 transition-all">
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            <ion-icon name="briefcase-outline" class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400"></ion-icon>
                            <input type="text" name="jenis_tugas[]" class="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium" placeholder="Contoh: Liturgos" value="Liturgos">
                        </div>
                    </div>
                    <div class="md:col-span-7">
                         <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Nama Petugas</label>
