    ...
    <form action="<?= base_url('dashboard/jadwal_pelayanan/store') ?>" method="post">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div class="space-y-3">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="nama_ibadah" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium placeholder-slate-400" placeholder="Contoh: Ibadah Minggu Raya" value="Ibadah Minggu Raya" required>
                    </div>
                    <div class="space-y-1">
                         <label class="block text-[10px] font-bold text-slate-700 uppercase tracking-wider">Tema Ibadah</label>
                         <input type="text" name="tema" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium placeholder-slate-400" placeholder="Contoh: Hidup yang Berbuah">
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    <div class="grid grid-cols-2 gap-3">
                        <div class="space-y-1">
                            ...
                            <input type="date" name="tanggal" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium text-slate-600" required value="<?= date('Y-m-d', strtotime('next Sunday')) ?>">
                        </div>
                        <div class="space-y-1">
                            <label class="block text-[10px] font-bold text-slate-700 uppercase tracking-wider">Jam <span class="text-rose-500">*</span></label>
                            <input type="time" name="jam" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm font-medium text-slate-600" required value="09:00">
                        </div>
                    </div>
                    <div class="space-y-1">
        ...
        <div class="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-4 md:p-5 mb-4">
            ...
            <div id="petugas-container" class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="petugas-row relative bg-white p-3 rounded-xl border border-slate-100 shadow-sm group hover:border-indigo-200 transition-all">
                    <div class="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-slate-800 text-white text-[10px] font-bold flex items-center justify-center shadow-md z-10 row-number">1</div>
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="jenis_tugas[]" class="w-full pl-8 pr-2 py-1.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-xs font-medium" placeholder="Contoh: Pengkotbah" value="Pengkotbah">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="nama_petugas[]" rows="2" class="w-full pl-8 pr-2 py-1.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-xs font-medium resize-none min-h-[38px]" placeholder="Masukkan Keterangan atau Nama Petugas..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="petugas-row relative bg-white p-3 rounded-xl border border-slate-100 shadow-sm group hover:border-indigo-200 transition-all">
                    <div class="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-slate-800 text-white text-[10px] font-bold flex items-center justify-center shadow-md z-10 row-number">2</div>
                    <button type="button" class="remove-row absolute -top-2 -right-2 w-6 h-6 rounded-full bg-rose-500 text-white flex items-center justify-center transition-all scale-75 opacity-0 group-hover:opacity-100 group-hover:scale-100 shadow-md z-10" title="Hapus Baris">
                        <ion-icon name="close-outline"></ion-icon>
                    </button>
                    <div class="grid grid-cols-12 gap-2">
                        <div class="col-span-4">
                            ...
                            <div class="relative">
                                <ion-icon name="briefcase-outline" class="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></ion-icon>
                                <input type="text" name="jenis_tugas[]" class="w-full pl-8 pr-2 py-1.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-xs font-medium" placeholder="Contoh: Liturgos" value="Liturgos">
                            </div>
                        </div>
        ...
        <div class="flex justify-end pt-4">
            <button type="submit" class="w-full md:w-auto px-8 py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 hover:shadow-indigo-300 hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
                ...
                <span>SIMPAN JADWAL IBADAH</span>
            </button>
        </div>
    </form>
</div>
