...
<div class="max-w-full mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        ...
        <form action="<?= base_url('dashboard/renungan/store') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="judul" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" required placeholder="Judul Renungan...">
            </div>

            <div class="mb-6">
                <label class="block text-sm font-medium text-slate-700 mb-2">Isi Renungan</label>
                <textarea id="editor" name="isi" class="w-full px-4 py-2 border border-slate-300 rounded-lg"></textarea>
            </div>
