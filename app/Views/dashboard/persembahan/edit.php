        ...
        <form action="<?= base_url('dashboard/persembahan/update/'.$persembahan['id_persembahan']) ?>" method="post">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="judul" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" required value="<?= $persembahan['judul'] ?>">
                </div>
                <div>
