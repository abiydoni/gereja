...
<div class="max-w-full mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        <div class="mb-6 border-b border-slate-100 pb-4">
            <h3 class="text-lg font-bold text-slate-800">Tambah Liturgi</h3>
        </div>
        ...
        <form action="<?= base_url('dashboard/liturgi/store') ?>" method="post">
            ...
            <div class="mb-6">
                ...
                <textarea id="editor" name="isi_liturgi" class="w-full px-4 py-2 border border-slate-300 rounded-lg"></textarea>
            </div>
