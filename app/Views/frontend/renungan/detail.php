...
<div class="bg-primary pt-10 pb-16 border-b border-white/5 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10" data-aos="fade-down">
        ...
        <h1 class="text-xl md:text-2xl font-extrabold text-white font-heading leading-tight"><?= esc($renungan['judul']) ?></h1>
    </div>
</div>

<div class="max-w-7xl mx-auto px-6 lg:px-8 -mt-8 mb-12 relative z-10">
    <div class="bg-white rounded-[24px] md:rounded-[40px] shadow-2xl shadow-primary/5 p-5 md:p-12 mb-12 border border-slate-100 relative overflow-hidden">
        <?php if(!empty($renungan['gambar'])): ?>
            <div class="-mx-5 md:-mx-12 -mt-5 md:-mt-12 mb-8 md:mb-12 h-48 md:h-96 relative overflow-hidden group">
